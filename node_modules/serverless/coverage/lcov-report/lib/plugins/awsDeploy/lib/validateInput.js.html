...
<html lang="en">
<head>
    <title>Code coverage report for lib/plugins/awsDeploy/lib/validateInput.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../../index.html">all files</a> / <a href="index.html">lib/plugins/awsDeploy/lib/</a> validateInput.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (!this.serverless.service.environment
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    return BbPromise.resolve();</span>
  },
};
&nbsp;</pre></td></tr>
</table></pre>
