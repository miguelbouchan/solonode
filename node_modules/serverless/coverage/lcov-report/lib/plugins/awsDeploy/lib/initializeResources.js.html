...
<html lang="en">
<head>
    <title>Code coverage report for lib/plugins/awsDeploy/lib/initializeResources.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../../index.html">all files</a> / <a href="index.html">lib/plugins/awsDeploy/lib/</a> initializeResources.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (this.serverless.service.resources.aws) {
...
<span class="cstat-no" title="statement not covered" >      this.serverless.service.resources.aws = coreCFTemplate;</span>
    }
&nbsp;
